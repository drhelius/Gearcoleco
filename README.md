...
- In debugger mode you can dock windows together by pressing SHIFT and drag'n drop a window into another. You can drag debugger windows outside the main window in macOS and Windows builds.
