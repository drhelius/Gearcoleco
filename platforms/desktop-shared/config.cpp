...
void config_init(void)
{
    ...
    config_input[1].key_left_button = SDL_SCANCODE_M;
    config_input[1].key_right_button = SDL_SCANCODE_M;
    config_input[1].key_0 = SDL_SCANCODE_M;
    config_input[1].key_1 = SDL_SCANCODE_M;
    config_input[1].key_2 = SDL_SCANCODE_M;
    config_input[1].key_3 = SDL_SCANCODE_M;
    config_input[1].key_4 = SDL_SCANCODE_M;
    config_input[1].key_5 = SDL_SCANCODE_M;
    config_input[1].key_6 = SDL_SCANCODE_M;
    config_input[1].key_7 = SDL_SCANCODE_M;
    config_input[1].key_8 = SDL_SCANCODE_M;
    config_input[1].key_9 = SDL_SCANCODE_M;
    config_input[1].key_asterisk = SDL_SCANCODE_M;
    config_input[1].key_hash = SDL_SCANCODE_M;
...
void config_read(void)
{
    ...
    config_input[1].key_left_button = (SDL_Scancode)read_int("InputB", "KeyLeftButton", SDL_SCANCODE_M);
    config_input[1].key_right_button = (SDL_Scancode)read_int("InputB", "KeyRightButton", SDL_SCANCODE_M);
    config_input[1].key_0 = (SDL_Scancode)read_int("InputB", "Key0", SDL_SCANCODE_M);
    config_input[1].key_1 = (SDL_Scancode)read_int("InputB", "Key1", SDL_SCANCODE_M);
    config_input[1].key_2 = (SDL_Scancode)read_int("InputB", "Key2", SDL_SCANCODE_M);
    config_input[1].key_3 = (SDL_Scancode)read_int("InputB", "Key3", SDL_SCANCODE_M);
    config_input[1].key_4 = (SDL_Scancode)read_int("InputB", "Key4", SDL_SCANCODE_M);
    config_input[1].key_5 = (SDL_Scancode)read_int("InputB", "Key5", SDL_SCANCODE_M);
    config_input[1].key_6 = (SDL_Scancode)read_int("InputB", "Key6", SDL_SCANCODE_M);
    config_input[1].key_7 = (SDL_Scancode)read_int("InputB", "Key7", SDL_SCANCODE_M);
    config_input[1].key_8 = (SDL_Scancode)read_int("InputB", "Key8", SDL_SCANCODE_M);
    config_input[1].key_9 = (SDL_Scancode)read_int("InputB", "Key9", SDL_SCANCODE_M);
    config_input[1].key_asterisk = (SDL_Scancode)read_int("InputB", "KeyAsterisk", SDL_SCANCODE_M);
    config_input[1].key_hash = (SDL_Scancode)read_int("InputB", "KeyHash", SDL_SCANCODE_M);
