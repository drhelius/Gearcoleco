...
final class EmulationViewController: UIViewController, UIAdaptivePresentationControllerDelegate {
    private var rom: Rom
    private let emulator = GearcolecoEmulator()
    ...
    private func configureViews() {
        ...
        emulator.configure(
            ...
            videoChip: AppSettings.videoChip.rawValue,
    ...
    private func layoutScreen() {
        ...
        if landscape {
            ...
            let right = min(controlsView.actionYellow.frame.minX, controlsView.keypad.frame.minX) - 12.0
    ...
    private func emulatorButton(for button: GameControllerInput.Button) -> GearcolecoButton? {
        switch button {
        case .up: return .up
