...
void gui_popup_modal_about(void)
{
    if (ImGui::BeginPopupModal("About " GEARCOLECO_TITLE, NULL, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ...
        ImGui::TextLinkOpenURL("https://github.com/drhelius/" GEARCOLECO_TITLE);
        ImGui::Text(" "); ImGui::SameLine();
        ...
        if (ImGui::BeginTabBar("##Tabs", ImGuiTabBarFlags_None))
        {
            if (ImGui::BeginTabItem("Build Info"))
            {
                ...
                add_build_info("define: DEBUG_GEARCOLECO\n");
                #endif
                #if defined(PERFORMANCE)
                add_build_info("define: PERFORMANCE\n");
                #endif
                #if defined(GEARCOLECO_DISABLE_DISASSEMBLER)
                add_build_info("define: GEARCOLECO_DISABLE_DISASSEMBLER\n");
                #endif
