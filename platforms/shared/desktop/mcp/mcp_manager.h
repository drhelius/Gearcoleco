...
public:
    ...
    void PumpCommands(GearcolecoCore* core)
    {
...
private:
    ...
    bool is_valid_button_name(const std::string& button) const
    {
        ...
        return button_lower == "up" || button_lower == "down" ||
            ...
            button_lower == "0" || button_lower == "1" || button_lower == "2" ||
            button_lower == "3" || button_lower == "4" || button_lower == "5" ||
            button_lower == "6" || button_lower == "7" || button_lower == "8" ||
            button_lower == "9" || button_lower == "asterisk" || button_lower == "*" ||
            button_lower == "hash" || button_lower == "#" ||
            button_lower == "left_button" || button_lower == "right_button" ||
            button_lower == "yellow" || button_lower == "red" ||
            button_lower == "fire1" || button_lower == "fire2" ||
            button_lower == "blue" || button_lower == "purple";
    }
    ...
    void pump_input_macro(GearcolecoCore* core)
    {
    ...
    void continue_input_macro_wait(GearcolecoCore* core)
    {
    ...
    void handle_controller_side_effects(GearcolecoCore* core, json& result)
    {
