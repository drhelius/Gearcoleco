...
static void set_style_light(ImGuiStyle& style)
{
    ...
    style.Colors[ImGuiCol_BorderShadow] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 0.0f);
    style.Colors[ImGuiCol_FrameBg] = ImVec4(0.770f, 0.770f, 0.770f, 1.0f);
    style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    ...
    style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    ...
    style.Colors[ImGuiCol_SeparatorHovered] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    style.Colors[ImGuiCol_SeparatorActive] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    style.Colors[ImGuiCol_ResizeGrip] = ImVec4(0.520f, 0.520f, 0.520f, 0.55f);
    style.Colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 0.80f);
    style.Colors[ImGuiCol_ResizeGripActive] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 0.95f);
    ...
    style.Colors[ImGuiCol_TextSelectedBg] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 0.35f);
    style.Colors[ImGuiCol_DragDropTarget] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    style.Colors[ImGuiCol_NavHighlight] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 0.90f);
    ...
    style.Colors[ImGuiCol_DockingPreview] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 0.45f);
    ...
    style.Colors[ImGuiCol_TabSelectedOverline] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
    ...
    style.Colors[ImGuiCol_TabDimmedSelectedOverline] = ImVec4(0.5764706f, 0.44705882f, 0.36078431f, 1.0f);
}
