...
static void set_style_light(ImGuiStyle& style)
{
    ...
    const ImVec4 accent_soft = make_color(0xF2E7DD);
    const ImVec4 accent_hover = make_color(0xF0E4D9);
    const ImVec4 accent_selected = make_color(0xEBDACA);
    const ImVec4 accent_edge = make_color(0xCEA37E);
    const ImVec4 accent_ink = make_color(0x815E46);
    const ImVec4 accent_strong = make_color(0x3E332E);
    const ImVec4 accent_bright = make_color(0x93725C);
    ...
    style.Colors[ImGuiCol_ResizeGripHovered] = make_color(0xCEA37E, 0.80f);
    style.Colors[ImGuiCol_ResizeGripActive] = make_color(0x815E46, 0.95f);
    ...
    style.Colors[ImGuiCol_NavHighlight] = make_color(0x93725C, 0.90f);
    ...
    style.Colors[ImGuiCol_DockingPreview] = make_color(0x93725C, 0.45f);
