# Gearcoleco iOS User Guide

## Supported games and controls

- Supported files: `.col`, `.cv`, `.bin`, `.rom`, and `.zip`.
- Controls: directional pad, Yellow, Red, Blue, Purple, and the ColecoVision keypad.
- One connected Apple-compatible game controller can be used for Player 1.
- A `colecovision.rom` BIOS is required and must be exactly 8 KB.
...
- The complete ColecoVision keypad remains visible with the other controls in both orientations.
